...
export default function NotesPage() {
  ...
  return (
    ...
    <div className="flex flex-row flex-wrap ml-5 mt-5 gap-4">
      <button className="transition-colors ease-in-out duration-300 h-60 w-60 border-b-black border-2 bg-zinc-400 hover:bg-zinc-500 active:bg-zinc-600" onClick={() => setNotes([...notes, {}])}>
        <div className="text-white">New Note</div>
      </button>
      {notes.map((note, i) =>
        <div className="h-60 w-60 border-b-black border-2 flex justify-center items-center" onClick={() => document.getElementById('my_modal_1').showModal()}>Topic</div>
